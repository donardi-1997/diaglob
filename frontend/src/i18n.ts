...
const resources = {
  es: {
    ...
    plans: "Planes",
      ...
      knowledgeI18nProvisioningAnimationSlowMessage: "Esto puede tardar unos momentos. Seguimos trabajando en ello.",
  ...
  en: {
    translation: {
      ...
      knowledgeI18nProvisioningAnimationSlowMessage: "This may take a few moments. We're still working on it.",
