...
const resources = {
  es: {
    ...
    plans: "Planes",
      ...
      landingIntegrationDropiIndirectDesc: "La IA de Diaglob realiza compras en Dropi, conoce el stock disponible y genera órdenes automáticamente.",
  ...
  en: {
    translation: {
      ...
      landingIntegrationDropiIndirect: "Dropi",
      landingIntegrationDropiIndirectDesc: "Diaglob's AI makes purchases on Dropi, knows available stock and generates orders automatically.",
