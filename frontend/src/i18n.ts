...
const resources = {
  es: {
    ...
    plans: "Planes",
      ...
      landingIntegrationDropi: "Dropi (Directo)",
      landingIntegrationDropiDesc: "Sincronización automática de catálogo, pedidos, envíos y tracking en tiempo real.",
      landingIntegrationDropiIndirect: "Dropi (Indirecto)",
      landingIntegrationDropiIndirectDesc: "Integración actual vía Google Sheets. Próximamente conexión directa con más utilidades.",

      landingIntegrationAvailable: "Disponible",
      landingIntegrationComingSoon: "Próximamente",
      landingIntegrationBeta: "Beta",

      // ── Dropi Coming Soon Utilities ──
      landingDropiComingSoonTitle: "Dropi Directo — Próximamente",
      landingDropiComingSoonSubtitle: "La integración directa con Dropi transformará tu operación de dropshipping.",
      landingDropiUtility1Title: "Catálogo automático",
      landingDropiUtility1Desc: "Productos, variantes, precios e imágenes se sincronizan solos desde Dropi a Diaglob.",
      landingDropiUtility2Title: "Gestión de envíos",
      landingDropiUtility2Desc: "Crea envíos, rastrea paquetes y notifica a tus clientes automáticamente.",
      landingDropiUtility3Title: "Alertas de stock",
      landingDropiUtility3Desc: "Recibe notificaciones cuando un producto se agota o cambia de precio en Dropi.",
      landingDropiUtility4Title: "Reportes por proveedor",
      landingDropiUtility4Desc: "Métricas de rendimiento, tiempos de envío y satisfacción por proveedor.",
      landingDropiUtility5Title: "Automatización post-venta",
      landingDropiUtility5Desc: "Seguimiento automático: confirmación, envío, entrega y solicitud de reseña.",
      landingDropiUtility6Title: "Multi-proveedor",
      landingDropiUtility6Desc: "Maneja múltiples proveedores de Dropi con reglas de asignación automática.",
  ...
  en: {
    translation: {
      ...
      landingIntegrationDropi: "Dropi (Direct)",
      landingIntegrationDropiDesc: "Automatic catalog sync, orders, shipping and real-time tracking.",
      landingIntegrationDropiIndirect: "Dropi (Indirect)",
      landingIntegrationDropiIndirectDesc: "Current integration via Google Sheets. Direct connection with more utilities coming soon.",
      ...
      // ── Dropi Coming Soon Utilities ──
      landingDropiComingSoonTitle: "Direct Dropi — Coming Soon",
      landingDropiComingSoonSubtitle: "The direct Dropi integration will transform your dropshipping operation.",
      landingDropiUtility1Title: "Automatic catalog",
      landingDropiUtility1Desc: "Products, variants, prices and images sync automatically from Dropi to Diaglob.",
      landingDropiUtility2Title: "Shipping management",
      landingDropiUtility2Desc: "Create shipments, track packages and notify your customers automatically.",
      landingDropiUtility3Title: "Stock alerts",
      landingDropiUtility3Desc: "Get notifications when a product runs out or changes price on Dropi.",
      landingDropiUtility4Title: "Reports by supplier",
      landingDropiUtility4Desc: "Performance metrics, shipping times and satisfaction by supplier.",
      landingDropiUtility5Title: "Post-sale automation",
      landingDropiUtility5Desc: "Automatic follow-up: confirmation, shipping, delivery and review request.",
      landingDropiUtility6Title: "Multi-supplier",
      landingDropiUtility6Desc: "Manage multiple Dropi suppliers with automatic assignment rules.",
