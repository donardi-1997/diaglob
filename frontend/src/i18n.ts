...
const resources = {
  es: {
    ...
    plans: "Planes",
      ...
      landingIntegrationDropiIndirectDesc: "Integración vía Google Sheets. Próximamente conexión directa con seguimiento de envíos.",
  ...
  en: {
    translation: {
      ...
      landingIntegrationDropiIndirect: "Dropi",
      landingIntegrationDropiIndirectDesc: "Integration via Google Sheets. Direct connection with shipping tracking coming soon.",
