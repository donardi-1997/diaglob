...
const resources = {
  es: {
    ...
    plans: "Planes",
      ...
      landingProblemTitle: "Vender por WhatsApp no debería sentirse caótico.",
      ...
      landingHowStep1Title: "Cliente escribe",
      landingHowStep1Desc: "Un contacto te escribe por WhatsApp con una consulta o pedido.",
      landingHowStep2Title: "Diaglob centraliza",
      landingHowStep2Desc: "La conversación se registra y se asigna al contexto correcto.",
      landingHowStep3Title: "IA ayuda a responder",
      landingHowStep3Desc: "Un agente configurado responde, recomienda o resuelve automáticamente.",
      landingHowStep4Title: "Se conecta con commerce",
      landingHowStep4Desc: "Productos, variantes y pedidos se vinculan a la conversación.",
      landingHowStep5Title: "Automatizaciones reaccionan",
      landingHowStep5Desc: "Reglas ejecutan acciones cuando ocurren eventos importantes.",
      landingHowStep6Title: "Analytics muestra resultados",
      landingHowStep6Desc: "Métricas de conversaciones, comercio y automatizaciones en tiempo real.",

      landingFeaturesTitle: "Todo lo que necesitas en una plataforma",
  ...
  en: {
    translation: {
      ...
      landingProblemTitle: "Selling on WhatsApp shouldn't feel chaotic.",
      ...
      landingHowStep1Title: "Customer writes",
      landingHowStep1Desc: "A contact messages you on WhatsApp with a question or order.",
      landingHowStep2Title: "Diaglob centralizes",
      landingHowStep2Desc: "The conversation is logged and assigned to the right context.",
      landingHowStep3Title: "AI helps respond",
      landingHowStep3Desc: "A configured agent responds, recommends or resolves automatically.",
      landingHowStep4Title: "Connects to commerce",
      landingHowStep4Desc: "Products, variants and orders are linked to the conversation.",
      landingHowStep5Title: "Automations react",
      landingHowStep5Desc: "Rules execute actions when important events occur.",
      landingHowStep6Title: "Analytics shows results",
      landingHowStep6Desc: "Real-time metrics for conversations, commerce and automations.",
