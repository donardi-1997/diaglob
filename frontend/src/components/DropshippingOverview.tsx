    ...
    getDropshippingOverview(storeId, dateFrom, dateTo)
      ...
      .catch((err: any) => {
        if (!cancelled) {
          console.error(err);
          setError(
            err?.response?.data?.detail || t("analyticsLoadError"),
          );
        }
      })
      .finally(() => {
    ...
    <div className="dropshipping-overview">
      <div className="analytics-stats-grid">
        ...
        <div className="analytics-stat-card">
          ...
          <div className="analytics-stat-value">
            {formatCurrency(data.delivered_revenue)}
          </div>
          <div className="analytics-stat-label">
            {t("dsDeliveredRevenue")}
          </div>
        </div>
          ...
          <div className="analytics-metrics-list">
            <div className="analytics-metric-row">
              ...
              <span className="analytics-metric-value">
                {formatRate(data.confirmation_rate)}
              </span>
            </div>
            <div className="analytics-metric-row">
            ...
            <div className="analytics-metric-row">
              ...
              <span className="analytics-metric-value">
                {formatRate(data.cancellation_rate)}
              </span>
            </div>
            <div className="analytics-metric-row">
              <span>{t("dsReturnRate")}</span>
              <span className="analytics-metric-value">
                {formatRate(data.return_rate)}
              </span>
            </div>
          </div>
        </div>
